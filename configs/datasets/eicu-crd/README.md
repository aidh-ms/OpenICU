...
- `2.0/` — current configuration: 14 table configs (`tables/`) and the
  beginnings of the per-dataset concept mappings (`mappings/`, currently only
...
(see the `to_datetime`/`add_offset` callbacks in e.g. `2.0/tables/lab.yml`).
